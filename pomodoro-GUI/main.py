...
label.config(fg=MARRON, font=(FONT_NAME, 18), bg=YELLOW)
...
button1.config(bg=PINK, highlightthickness=0)
button1.grid(row=2, column=0)

# Button 2
button2 = Button(text="Reset", command=reset_timer)
button2.config(bg=PINK, highlightthickness=0)
button2.grid(row=2, column=2)

# Tick mark label
tick_mark = Label()
tick_mark.config(fg=MARRON, font=(FONT_NAME, 18), bg=YELLOW)
